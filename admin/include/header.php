...
<body>
  ...
  <div class="row" style="height: 520px;">
    ...
    <div class="col-md-3 d-print-none h-100">
      <!-- Sidebar -->
      <nav class="p-0 m-0 border-secondary border-end h-100 w-100 <?php
        ...
        <div class="border-bottom p-3 fs-4 mb-5 " style="background-color:#fff9ece2;">
          <?php
