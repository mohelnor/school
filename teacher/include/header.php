...
<head>
  ...
  <style>
    body {
      background-color: #dbffdde2;
    }

    .active {
      font-weight: bold !important;
      color: #000 !important;
      background-color: #dbffdde2 !important;
      border-color: #dbffdde2 !important;
    }
...
<div class="row" style="height: 520px;">
    ...
    <div class="col-md-3 d-print-none">
      ...
      <nav class="p-0 m-0 border-secondary border-end h-100 w-100 <?php
        ...
        <div class="border-bottom p-3 fs-4" style="background-color:#dbffdde2;">
        <?php
