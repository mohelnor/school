...
--
-- Host: localhost
-- Generation Time: Dec 08, 2021 at 06:39 PM
...
INSERT INTO `assets` (`id`, `subject`, `class`, `asset`, `src`, `created`, `updated`) VALUES
(1, 1, 1, 'العرب', '1.PNG', '2021-12-07 21:23:03', '2021-12-07 21:23:03'),
(2, 1, 1, 'كتاب البيان', 't1.PNG', '2021-12-08 20:34:18', '2021-12-08 20:34:18');
...
(4, 1, 1, 1, 60, '2021-12-07 10:39:27', '2021-12-08 18:54:59');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `examview`  AS  select `questions`.`id` AS `id`,`questions`.`exam` AS `exam`,`questions`.`question` AS `question`,`questions`.`answer` AS `correct`,`questions`.`degree` AS `degree`,`answers`.`id` AS `answerID`,`answers`.`answer` AS `answer` from (`questions` join `answers` on((`questions`.`id` = `answers`.`question`))) ;
